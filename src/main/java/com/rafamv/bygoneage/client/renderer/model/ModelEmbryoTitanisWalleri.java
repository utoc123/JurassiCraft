...
public class ModelEmbryoTitanisWalleri extends ModelBase {
	...
	public ModelEmbryoTitanisWalleri() {
		textureWidth = 32;
		textureHeight = 64;
		...
		snout.addBox(-1F, 0F, -1F, 2, 2, 2);
		snout.setRotationPoint(0F, 13F, -5F);
		snout.setTextureSize(32, 32);
		snout.mirror = true;
		setRotation(snout, -1.047198F, 0F, 0F);
	}
