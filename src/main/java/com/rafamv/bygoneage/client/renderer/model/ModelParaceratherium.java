...
public class ModelParaceratherium extends ModelBase {
	...
	public ModelParaceratherium() {
		...
		bodyFront.setRotationPoint(0F, -25F, 25F);
		bodyFront.setTextureSize(512, 256);
		bodyFront.mirror = true;
		setRotation(bodyFront, -0.2094395F, 0F, 0F);
		bodyNeck = new ResettableModelRenderer(this, 0, 0);
		bodyNeck.addBox(-12F, -7F, -49F, 22, 23, 8);
		bodyNeck.setRotationPoint(0F, -25F, 25F);
		bodyNeck.setTextureSize(512, 256);
		bodyNeck.mirror = true;
		setRotation(bodyNeck, -0.2094395F, 0F, 0F);
		tail1 = new ResettableModelRenderer(this, 0, 0);
		tail1.addBox(-2F, -2F, 0F, 4, 4, 5);
		tail1.setRotationPoint(0F, -25F, 44F);
		tail1.setTextureSize(512, 256);
		tail1.mirror = true;
		setRotation(tail1, -0.2617994F, 0F, 0F);
		tail2 = new ResettableModelRenderer(this, 0, 0);
		tail2.addBox(-1.5F, 1F, 1F, 3, 15, 4);
		tail2.setRotationPoint(0F, -25F, 44F);
		tail2.setTextureSize(512, 256);
		tail2.mirror = true;
		setRotation(tail2, 0.2617994F, 0F, 0F);
		tail3 = new ResettableModelRenderer(this, 0, 0);
		tail3.addBox(-1F, 0F, -1.5F, 2, 16, 3);
		tail3.setRotationPoint(0F, -12F, 50.5F);
		tail3.setTextureSize(512, 256);
		tail3.mirror = true;
		setRotation(tail3, 0F, 0F, 0F);
		neck1 = new ResettableModelRenderer(this, 0, 0);
		neck1.addBox(-8F, -12F, -14F, 16, 20, 22);
		neck1.setRotationPoint(0F, -32F, -26F);
		neck1.setTextureSize(512, 256);
		neck1.mirror = true;
		setRotation(neck1, -0.7853982F, 0F, 0F);
		neck2 = new ResettableModelRenderer(this, 0, 0);
		neck2.addBox(-7F, -17F, -26F, 14, 17, 20);
		neck2.setRotationPoint(0F, -32F, -26F);
		neck2.setTextureSize(512, 256);
		neck2.mirror = true;
		setRotation(neck2, -0.2617994F, 0F, 0F);
		earRight = new ResettableModelRenderer(this, 0, 0);
		earRight.addBox(0F, -24F, -30F, 2, 10, 4);
		earRight.setRotationPoint(0F, -32F, -26F);
		earRight.setTextureSize(512, 256);
		earRight.mirror = true;
		setRotation(earRight, -0.3490659F, 0F, -0.3490659F);
		earLeft = new ResettableModelRenderer(this, 0, 0);
		earLeft.addBox(-2F, -24F, -30F, 2, 10, 4);
		earLeft.setRotationPoint(0F, -32F, -26F);
		earLeft.setTextureSize(512, 256);
		earLeft.mirror = true;
		setRotation(earLeft, -0.3490659F, 0F, 0.3490659F);
		head1 = new ResettableModelRenderer(this, 0, 0);
		head1.addBox(-8F, -25F, -28F, 16, 16, 10);
		head1.setRotationPoint(0F, -32F, -26F);
		head1.setTextureSize(512, 256);
		head1.mirror = true;
		setRotation(head1, 0.0872665F, 0F, 0F);
		head2 = new ResettableModelRenderer(this, 0, 0);
		head2.addBox(-7F, -31F, -36F, 14, 12, 16);
		head2.setRotationPoint(0F, -32F, -26F);
		head2.setTextureSize(512, 256);
		head2.mirror = true;
		setRotation(head2, 0.3490659F, 0F, 0F);
		head3 = new ResettableModelRenderer(this, 0, 0);
		head3.addBox(-6F, -9F, -46.8F, 12, 11, 7);
		head3.setRotationPoint(0F, -32F, -26F);
		head3.setTextureSize(512, 256);
		head3.mirror = true;
		setRotation(head3, -0.1745329F, 0F, 0F);
		mouth = new ResettableModelRenderer(this, 0, 0);
		mouth.addBox(-6F, -1F, -13F, 12, 4, 12);
		mouth.setRotationPoint(0F, -42F, -53F);
		//mouth.setRotationPoint(0F, -32F, -26F);
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
		...
		float naturalMouthMovement = 0.08F * MathHelper.sin(0.02F * f2);
		...
		neck1.rotateAngleX = 0.8F * headRotationX + neck1.firstRotateAngleX;
		neck2.rotateAngleX = 0.9F * headRotationX + neck2.firstRotateAngleX;
		head1.rotateAngleX = headRotationX + head1.firstRotateAngleX;
		head2.rotateAngleX = headRotationX + head2.firstRotateAngleX;
		head3.rotateAngleX = headRotationX + head3.firstRotateAngleX;
		mouth.rotateAngleX = headRotationX + mouth.firstRotateAngleX;

		neck1.rotateAngleY = 0.8F * headRotationY + neck1.firstRotateAngleY;
		neck2.rotateAngleY = 0.9F * headRotationY + neck2.firstRotateAngleY;
		head1.rotateAngleY = headRotationY + head1.firstRotateAngleY;
		head2.rotateAngleY = headRotationY + head2.firstRotateAngleY;
		head3.rotateAngleY = headRotationY + head3.firstRotateAngleY;
		mouth.rotateAngleY = headRotationY + mouth.firstRotateAngleY;
		...
		earRight.rotateAngleY = headRotationY + earRight.firstRotateAngleY;
		earLeft.rotateAngleY = headRotationY + earLeft.firstRotateAngleY;

		bodyBack.rotateAngleX = bodyBack.firstRotateAngleX;
		bodyFront.rotateAngleX = bodyFront.firstRotateAngleX;
		bodyNeck.rotateAngleX = bodyNeck.firstRotateAngleX;
