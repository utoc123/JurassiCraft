...
public class BackUpResettableModelRenderer extends ModelRenderer {
	...
	public BackUpResettableModelRenderer(ModelBase modelBase, int par1, int par2) {
	...
	public void copyAllRotationPoints(BackUpResettableModelRenderer target) {
	...
	public void copyXRotationPoint(BackUpResettableModelRenderer target) {
		this.rotationPointX = target.rotationPointX;
	}

	/** Copies Y rotation points. */
	public void copyYRotationPoint(BackUpResettableModelRenderer target) {
		this.rotationPointY = target.rotationPointY;
	}

	/** Copies Z rotation points. */
	public void copyZRotationPoint(BackUpResettableModelRenderer target) {
		this.rotationPointZ = target.rotationPointZ;
	}

	/** Pins a leg in the plane YZ. The angle used should be rotationX. */
	public void pinLegPlaneYZ(BackUpResettableModelRenderer parentBox, float radius, float rotationX) {
	...
	public void pinTailPlaneYZ(BackUpResettableModelRenderer parentBox, float radius, float rotationX) {
	 ...
	 * point. */
	public float calculateDistanceYZ(BackUpResettableModelRenderer target) {
	...
	public float calculateRadius(BackUpResettableModelRenderer target) {
