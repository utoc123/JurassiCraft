...
public class BygoneAgeEntityAIFollowFood extends EntityAIBase {
	private EntityBygoneAgeCreature temptedEntity;
	...
	public BygoneAgeEntityAIFollowFood(EntityBygoneAgeCreature creature, double velocity, boolean beAfraidOfMovement) {
	...
	public boolean shouldExecute() {
		if (this.delayTemptCounter > 0) {
			...
			if (this.temptingPlayer == null) {
				...
				return itemstack == null ? false : (BygoneAgeMobsInformation.isFavoriteFood(this.temptedEntity.getCreatureID(), itemstack.getItem()) && this.temptedEntity.getAttackTarget() == null);
			}
		}
	}
