...
public class BygoneAgeLandEntityAIPanicIfNotAnger extends EntityAIBase {

	private EntityBygoneAgeLandProtective runningCreature;
	private double speed;
	private double randPosX;
	private double randPosY;
	private double randPosZ;

	public BygoneAgeLandEntityAIPanicIfNotAnger(EntityBygoneAgeLandProtective creature, double newSpeed) {
