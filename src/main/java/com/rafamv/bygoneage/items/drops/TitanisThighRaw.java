...
public class TitanisThighRaw extends ItemFood implements AnyDNASource {

	public TitanisThighRaw(int hunger, float saturation, boolean isWolfFood) {
	...
	public void registerIcons(IIconRegister iconRegister) {
		this.itemIcon = iconRegister.registerIcon(BygoneAge.MODID + ":" + BygoneAgeItems.titanisThighRaw.getUnlocalizedName().substring(5));
	}
}