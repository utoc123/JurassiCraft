...
public class LeptictidiumHide extends Item implements AnyDNASource {

	public LeptictidiumHide() {
	...
	public void registerIcons(IIconRegister iconRegister) {
		this.itemIcon = iconRegister.registerIcon(BygoneAge.MODID + ":" + BygoneAgeItems.leptictidiumHide.getUnlocalizedName().substring(5));
	}
