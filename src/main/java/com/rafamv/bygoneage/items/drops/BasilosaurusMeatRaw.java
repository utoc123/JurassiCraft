...
public class BasilosaurusMeatRaw extends ItemFood implements AnyDNASource {

	public BasilosaurusMeatRaw(int hunger, float saturation, boolean isWolfFood) {
	...
	public void registerIcons(IIconRegister iconRegister) {
		this.itemIcon = iconRegister.registerIcon(BygoneAge.MODID + ":" + BygoneAgeItems.basilosaurusMeatRaw.getUnlocalizedName().substring(5));
	}
}