...
public class ArsinoitheriumMeatRaw extends ItemFood implements AnyDNASource {

	public ArsinoitheriumMeatRaw(int hunger, float saturation, boolean isWolfFood) {
	...
	public void registerIcons(IIconRegister iconRegister) {
		this.itemIcon = iconRegister.registerIcon(BygoneAge.MODID + ":" + BygoneAgeItems.arsinoitheriumMeatRaw.getUnlocalizedName().substring(5));
	}
}