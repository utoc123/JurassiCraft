...
public class PorkOnAStick extends Item {
	...
	public void registerIcons(IIconRegister iconRegister) {
		this.itemIcon = iconRegister.registerIcon(BygoneAge.MODID + ":" + BygoneAgeItems.porkOnStick.getUnlocalizedName().substring(5));
	}
}
