...
public class BeefOnAStick extends Item {
	...
	public void registerIcons(IIconRegister iconRegister) {
		this.itemIcon = iconRegister.registerIcon(BygoneAge.MODID + ":" + BygoneAgeItems.beefOnStick.getUnlocalizedName().substring(5));
	}
}
