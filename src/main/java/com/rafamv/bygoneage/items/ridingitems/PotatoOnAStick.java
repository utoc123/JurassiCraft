...
public class PotatoOnAStick extends Item {

	public PotatoOnAStick() {
	...
	public void registerIcons(IIconRegister iconRegister) {
		this.itemIcon = iconRegister.registerIcon(BygoneAge.MODID + ":" + BygoneAgeItems.potatoOnStick.getUnlocalizedName().substring(5));
	}
}
