...
public class PrehistoricFeather extends Item implements AnyDNASource {

	public PrehistoricFeather() {
	...
	public void registerIcons(IIconRegister iconRegister) {
		this.itemIcon = iconRegister.registerIcon(BygoneAge.MODID + ":" + BygoneAgeItems.prehistoricFeather.getUnlocalizedName().substring(5));
	}
