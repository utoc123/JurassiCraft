...
public class PrehistoricFur extends Item implements AnyDNASource {

	public PrehistoricFur() {
	...
	public void registerIcons(IIconRegister iconRegister) {
		this.itemIcon = iconRegister.registerIcon(BygoneAge.MODID + ":" + BygoneAgeItems.prehistoricFur.getUnlocalizedName().substring(5));
	}
