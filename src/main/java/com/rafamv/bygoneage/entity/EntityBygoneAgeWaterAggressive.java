...
public class EntityBygoneAgeWaterAggressive extends EntityBygoneAgeWaterCreature {

	public EntityBygoneAgeWaterAggressive(World world, byte id, float maxChildAge) {
	...
	private void becomeAngryAt(EntityBygoneAgeWaterAggressive creature, Entity target) {
			...
			if (attacker != (Entity) null && this.checkTarget(attacker)) {
				...
				for (int i = 0; i < list.size(); ++i) {
					...
					if (entityNeighbor.getClass() == this.getClass()) {
						EntityBygoneAgeWaterAggressive entityNeighborAngry = (EntityBygoneAgeWaterAggressive) entityNeighbor;
