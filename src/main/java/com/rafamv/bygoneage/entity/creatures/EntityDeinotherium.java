...
public class EntityDeinotherium extends EntityBygoneAgeLandProtective {
	...
	public EntityDeinotherium(World world) {
		...
		this.tasks.addTask(6, new EntityAIWatchClosest(this, EntityDeinotherium.class, 12.0F));
