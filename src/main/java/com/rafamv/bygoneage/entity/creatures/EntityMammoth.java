...
public class EntityMammoth extends EntityBygoneAgeLandProtective {

	public EntityMammoth(World world) {
		super(world, BygoneAgeGeneticsInformation.MAMMOTH.getCreatureID(), 1, 0.35F);
		...
		this.tasks.addTask(6, new EntityAIWatchClosest(this, EntityMammoth.class, 12.0F));
	...
	public void playLivingSound() {
		this.playSound(BygoneAge.MODID + ":" + "creature.mammoth.say", this.getSoundVolume(), this.getSoundPitch());
	}

	@Override
	public String getHurtSound() {
		this.playSound(BygoneAge.MODID + ":" + "creature.mammoth.hit", this.getSoundVolume(), this.getSoundPitch());
		return null;
	}

	@Override
	public String getDeathSound() {
		this.playSound(BygoneAge.MODID + ":" + "creature.mammoth.death", this.getSoundVolume(), this.getSoundPitch());
		return null;
	}
