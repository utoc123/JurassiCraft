...
public class FossilModelPlesiosaurus extends AnyFossilModel implements ITileEntityProvider {

	public FossilModelPlesiosaurus() {
	...
	public TileEntity createNewTileEntity(World world, int metadata) {
		try {
			return new TileEntityFossilPlesiosaurus();
		} catch (Exception e) {
