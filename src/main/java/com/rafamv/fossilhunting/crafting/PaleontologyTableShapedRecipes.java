...
public class PaleontologyTableShapedRecipes implements IRecipe {
	...
	public PaleontologyTableShapedRecipes(int par1, int par2,
		...
		if (this.field_92101_f) {
			for (int i = 0; i < par1InventoryCrafting.getSizeInventory(); ++i) {
				...
				if (itemstack1 != null && itemstack1.hasTagCompound()) {
					itemstack.setTagCompound((NBTTagCompound) itemstack1.stackTagCompound
									.copy());
				}
			}
		}
	...
	public PaleontologyTableShapedRecipes func_92100_c() {
