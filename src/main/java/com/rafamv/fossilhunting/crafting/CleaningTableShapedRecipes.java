...
public class CleaningTableShapedRecipes implements IRecipe {
	...
	public CleaningTableShapedRecipes(int par1, int par2,
	...
	public CleaningTableShapedRecipes func_92100_c() {
