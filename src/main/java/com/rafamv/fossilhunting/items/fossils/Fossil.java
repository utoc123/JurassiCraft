...
public class Fossil extends AnyFossilItem {
	...
	public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean flag) {
		list.add(FossilInformation.getChatColor(FossilInformation.values()[itemStack.getItemDamage()].getDiet()) + FossilInformation.values()[itemStack.getItemDamage()].getFossilName());
	}
