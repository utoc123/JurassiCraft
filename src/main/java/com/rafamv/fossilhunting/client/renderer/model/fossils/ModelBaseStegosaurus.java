...
public class ModelBaseStegosaurus {
    private IModelCustom modelFossil;
	private ResourceLocation modelLocation = new ResourceLocation(FossilHunting.MODID + ":" + "models/bases/StegosaurusBase.obj");

    public ModelBaseStegosaurus() {
