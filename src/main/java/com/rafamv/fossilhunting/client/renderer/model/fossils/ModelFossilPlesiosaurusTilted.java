...
public class ModelFossilPlesiosaurusTilted {
    private IModelCustom modelBase;
	private ResourceLocation modelLocation = new ResourceLocation(FossilHunting.MODID + ":" + "models/fossils/PlesiosaurusTilted.obj");

    public ModelFossilPlesiosaurusTilted() {
