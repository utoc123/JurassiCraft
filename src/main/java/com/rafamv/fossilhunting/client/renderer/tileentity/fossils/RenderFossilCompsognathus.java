...
import com.rafamv.fossilhunting.client.renderer.model.fossils.ModelFossilCompsognathus;
import com.rafamv.fossilhunting.tileentity.fossils.TileEntityFossilCompsognathus;

import cpw.mods.fml.client.FMLClientHandler;

public class RenderFossilCompsognathus extends TileEntitySpecialRenderer {
	...
	private ModelFossilCompsognathus modelFossil = new ModelFossilCompsognathus();

	@Override
	public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick) {
		if (tileEntity instanceof TileEntityFossilCompsognathus) {
			TileEntityFossilCompsognathus tileFossil = (TileEntityFossilCompsognathus) tileEntity;
