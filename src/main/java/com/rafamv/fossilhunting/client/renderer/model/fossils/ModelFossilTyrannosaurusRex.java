...
public class ModelFossilTyrannosaurusRex {
    private IModelCustom modelFossil;
	private ResourceLocation modelLocation = new ResourceLocation(FossilHunting.MODID + ":" + "models/fossils/TyrannosaurusRexFossil.obj");

    public ModelFossilTyrannosaurusRex() {
