...
public class ContainerAnalyzer extends Container
{
    ...
    public void detectAndSendChanges()
    {
        ...
        for (Object crafter : crafters)
        {
            ...
            if (cookTime != tileAnalyzer.analyzerCookTime) var2.sendProgressBarUpdate(this, 0, tileAnalyzer.analyzerCookTime);
            
            if (burnTime != tileAnalyzer.analyzerBurnTime) var2.sendProgressBarUpdate(this, 1, tileAnalyzer.analyzerBurnTime);
            
            if (itemBurnTime != tileAnalyzer.currentItemBurnTime) var2.sendProgressBarUpdate(this, 20, tileAnalyzer.currentItemBurnTime);
        }
