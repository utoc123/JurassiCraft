...
public class EntityTRex extends EntityAgeableMob
{
    ...
    public EntityTRex(World par1World)
    {
        ...
        this.tasks.addTask(3, new EntityAIAttackOnCollide(this, EntityStegosaurus.class, this.moveSpeed, true));
        ...
        this.targetTasks.addTask(2, new EntityAINearestAttackableTarget(this, EntityStegosaurus.class, 0, false));
