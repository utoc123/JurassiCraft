package com.ilexiconn.jurassicraft.data.entityOLD.model;

//import thehippomaster.AnimationAPI.IAnimatedEntity;
//import thehippomaster.AnimationAPI.client.Animator;

import com.ilexiconn.jurassicraft.data.entityOLD.EntityAnkylosaur;
...
//		animate((IAnimatedEntity)entityOLD, f, f1, f2, f3, f4, f5);
        Head.render(f5);
//        Mouth.render(f5);
...
/*    private void animate(IAnimatedEntity entityOLD, float f, float f1, float f2, float f3, float f4, float f5) {
 //   	animator.update(entityOLD);
    	setAngles();
        setRotationAngles(f, f1, f2, f3, f4, f5, (Entity) entityOLD);
	}*/
