...
public class BACKUP_EntityTyrannosaurus extends EntityDinosaurMonster
{   
	public int texid;
    ...
    public BACKUP_EntityTyrannosaurus(World par1World)
    {
        super(par1World, 6);
...
//    	return null;
    ...
    public BACKUP_EntityTyrannosaurus spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        return new BACKUP_EntityTyrannosaurus(this.worldObj);
    }
