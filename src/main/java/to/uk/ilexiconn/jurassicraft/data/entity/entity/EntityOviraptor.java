...
public class EntityOviraptor extends EntityJurassiCraftCreature {
	...
	public EntityOviraptor createChild(EntityAgeable entity) {
		return new EntityOviraptor(worldObj);
	}
}