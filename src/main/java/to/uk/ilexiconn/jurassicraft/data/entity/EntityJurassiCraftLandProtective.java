...
import to.uk.ilexiconn.jurassicraft.data.ai.JurassiCraftEntityAIAngerProtective;
import to.uk.ilexiconn.jurassicraft.data.ai.JurassiCraftEntityAIOwnerHurtByTarget;
import to.uk.ilexiconn.jurassicraft.data.ai.JurassiCraftEntityAIOwnerHurtTarget;
import to.uk.ilexiconn.jurassicraft.data.ai.JurassiCraftLandEntityAIPanicIfNotAnger;
...
public class EntityJurassiCraftLandProtective extends EntityJurassiCraftRidable {
	...
	private void cancelAngryBehavior(EntityJurassiCraftLandProtective howWasAttacking) {
