...
public class ModelTitanis extends MowzieModelBase
{
  ...
  public ModelTitanis()
  {
    ...
    textureHeight = 64;
      ...
      Beak_2.setInitValuesToCurrentPose();
      Head.setInitValuesToCurrentPose();
      Feather1.setInitValuesToCurrentPose();
      Feather2.setInitValuesToCurrentPose();
      Feather3.setInitValuesToCurrentPose();
      Neck.setInitValuesToCurrentPose();
      Neck_2.setInitValuesToCurrentPose();
      Chest.setInitValuesToCurrentPose();
      Beak_Ridge_Main.setInitValuesToCurrentPose();
      Feather_4.setInitValuesToCurrentPose();
      Left_Wing_1.setInitValuesToCurrentPose();
      Left_Wing_2.setInitValuesToCurrentPose();
      Rear.setInitValuesToCurrentPose();
      Tail1.setInitValuesToCurrentPose();
      Tail2.setInitValuesToCurrentPose();
      Tail3.setInitValuesToCurrentPose();
      Right_Wing1.setInitValuesToCurrentPose();
      Right_Wing2.setInitValuesToCurrentPose();
      Tailfeather1.setInitValuesToCurrentPose();
      Tailfeather2.setInitValuesToCurrentPose();
      Tailfeather3.setInitValuesToCurrentPose();
      Left_Thigh.setInitValuesToCurrentPose();
      Upper_Left_Leg.setInitValuesToCurrentPose();
      Lower_Left_Leg.setInitValuesToCurrentPose();
      Left_Foot.setInitValuesToCurrentPose();
      Right_Thigh.setInitValuesToCurrentPose();
      Upper_right_leg.setInitValuesToCurrentPose();
      Lower_Right_leg.setInitValuesToCurrentPose();
...
/*    Tail1.render(f5);
 ...
 /*   Upper_right_leg.render(f5);
  ...
  private void resetPose() {
      ...
      Front_Beak_Ridge.setCurrentPoseToInitValues();
      Jaw.setCurrentPoseToInitValues();
      Beak_2.setCurrentPoseToInitValues();
      Head.setCurrentPoseToInitValues();
      Feather1.setCurrentPoseToInitValues();
      Feather2.setCurrentPoseToInitValues();
      Feather3.setCurrentPoseToInitValues();
      Neck.setCurrentPoseToInitValues();
      Neck_2.setCurrentPoseToInitValues();
      Chest.setCurrentPoseToInitValues();
      Beak_Ridge_Main.setCurrentPoseToInitValues();
      Feather_4.setCurrentPoseToInitValues();
      Left_Wing_1.setCurrentPoseToInitValues();
      Left_Wing_2.setCurrentPoseToInitValues();
      Rear.setCurrentPoseToInitValues();
      Tail1.setCurrentPoseToInitValues();
      Tail2.setCurrentPoseToInitValues();
      Tail3.setCurrentPoseToInitValues();
      Right_Wing1.setCurrentPoseToInitValues();
      Right_Wing2.setCurrentPoseToInitValues();
      Tailfeather1.setCurrentPoseToInitValues();
      Tailfeather2.setCurrentPoseToInitValues();
      Tailfeather3.setCurrentPoseToInitValues();
      Left_Thigh.setCurrentPoseToInitValues();
      Upper_Left_Leg.setCurrentPoseToInitValues();
      Lower_Left_Leg.setCurrentPoseToInitValues();
      Left_Foot.setCurrentPoseToInitValues();
      Right_Thigh.setCurrentPoseToInitValues();
      Upper_right_leg.setCurrentPoseToInitValues();
      Lower_Right_leg.setCurrentPoseToInitValues();
