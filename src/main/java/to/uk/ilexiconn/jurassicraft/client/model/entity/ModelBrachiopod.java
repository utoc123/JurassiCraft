...
public class ModelBrachiopod extends ModelBase
{
    ...
    public ModelBrachiopod()
    {
        ...
        (this.backBottom = new ModelRenderer((ModelBase) this, 0, 27)).addBox(0.0f, 0.0f, 0.0f, 14, 4, 1);
        ...
        (this.frontBottom = new ModelRenderer((ModelBase) this, 0, 26)).addBox(0.0f, 0.0f, 0.0f, 14, 5, 1);
        ...
        (this.shellBottom = new ModelRenderer((ModelBase) this, 0, 0)).addBox(-7.0f, 23.0f, -7.0f, 14, 1, 14);
        ...
        (this.rightBottom = new ModelRenderer((ModelBase) this, 32, 10)).addBox(0.0f, 0.0f, 0.0f, 1, 4, 14);
        ...
        (this.leftBottom = new ModelRenderer((ModelBase) this, 32, 10)).addBox(0.0f, 0.0f, 0.0f, 1, 4, 14);
        ...
        (this.leftTop = new ModelRenderer((ModelBase) this, 32, 10)).addBox(5.0f, -4.0f, -14.0f, 1, 4, 14);
        ...
        (this.shellTop = new ModelRenderer((ModelBase) this, 0, 0)).addBox(-8.0f, -4.0f, -14.0f, 14, 1, 14);
        ...
        (this.frontTop = new ModelRenderer((ModelBase) this, 0, 26)).addBox(-8.0f, -4.0f, -14.0f, 14, 5, 1);
        ...
        (this.pearl = new ModelRenderer((ModelBase) this, 0, 17)).addBox(0.0f, 0.0f, -0.1f, 6, 2, 6);
        ...
        (this.backTop = new ModelRenderer((ModelBase) this, 0, 26)).addBox(-8.0f, -4.0f, -1.0f, 14, 5, 1);
        ...
        (this.rightTop = new ModelRenderer((ModelBase) this, 32, 10)).addBox(-8.0f, -4.0f, -14.0f, 1, 4, 14);
