...
public class EntityMoeritherium extends EntityJurassiCraftLandProtective implements IMammal
{
    public EntityMoeritherium(World world)
    {
        super(world, (byte) Util.classToId(EntityMoeritherium.class), 1);
        ...
        this.tasks.addTask(7, new JurassiCraftEntityAIHerdBehavior(this, 64, 2000, 20, 0.7D * this.getCreatureSpeed()));
